...
summarise(grouped_reg, 'Trump_Approve_Mean' = mean(CC18_308a))
```
 
# Problem 10

With dat, use summarise() to create a summary table for survey respondents who  are not investors
and who have an annual family income of between $40,000 and $119,999 per year.
